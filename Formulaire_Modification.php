...
<html>
<head>
        <title>Modfier un cursus</title>
        <link type='text/CSS' href='../include/CSS/style.js'>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
</head>
<body>
    <form method="POST" id='FormMoficationCursus' name='FormMoficationCursus' action="Formulaire_Modification_Action.php">
         <?php for ($i = 1; $i <= $UV_Numero; $i++) {
    echo ("UV N°".$i." -");
    echo (" <div>N° du Semestre : <input type='text' name='numsem' size='10' maxlength='10' value='' /></div>
