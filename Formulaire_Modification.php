        ...
        <body>
            ...
            <table>
                ...
                if (isset($_POST['numetu'], $_POST['cursus'])) {
                    ...
                    $req = "SELECT e.id FROM elt_de_formation e, cursus c WHERE c.nom='$cursus' AND c.id_etu=$etu AND c.id=e.id_cursus"; //récupère les éléments de formation en fonction du cursus
                    ?>
